...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("TemerCoins"));
    case mBTC: return QString(QObject::tr("Milli-TemerCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-TemerCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}

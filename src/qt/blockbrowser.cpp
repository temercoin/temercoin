...
{
    if(Height > pindexBest->nHeight) { return "0x000006f782c7ce827bb5921f96b14ca68692348c6376b43f02e554a84141ebc1"; }
    if(Height < 0) { return "0x000006f782c7ce827bb5921f96b14ca68692348c6376b43f02e554a84141ebc1"; }
    int desiredheight;
...
{    
    ...
    if(block == false) {
        ...
        ui->valueBox->setText(QValue + " TMC");
        ui->txID->setText(QID);
        ui->outputBox->setText(QOutputs);
        ui->inputBox->setText(QInputs);
        ui->feesBox->setText(QFees + " TMC");
    }
}

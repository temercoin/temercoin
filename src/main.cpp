...
const string strMessageMagic = "TemerCoin Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("TemerCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in TemerCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // TemerCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TemerCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "TemerCoin Genesis Block";
        CTransaction txNew;
        txNew.nTime = 1506196696;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1506196696;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 966338; // !fTestNet ? 1575379 : 46534;
		
        //block.print();

        //// debug print
        assert(block.hashMerkleRoot == uint256("0x7a042d0f9add9ee776b64d6fb5aafc10e894a737708c7c43e3733041557d61bd"));
